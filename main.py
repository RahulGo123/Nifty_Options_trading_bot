...
def _configure_logging() -> None:
    ...
    logger.info("Logging initialised. Log dir: %s", log_dir.resolve())
...
async def main() -> None:
    ...
    logger.info("[MAIN] Watchdog PID: %d", watchdog_proc.pid)
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "═" * 56)
        input("  SESSION COMPLETE. Press ENTER to close this window...")
